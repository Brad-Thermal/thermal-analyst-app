...
# Version Notes: 
# - Fixed a KeyError in the "Conclusions" tab that occurred when a spec was not provided for a Key IC.
# - Restored the complete and correct UI for the Viper Thermal Suite module.
